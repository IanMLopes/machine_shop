...
<div class="example-full">
  ...
  <div class="upload" v-show="!isOption">
            ...
            <td colspan="9">
              <div class="text-center p-5 " >
                <h4>Solte arquivos em qualquer lugar <br>
                 para fazer upload
                <br/>ou</h4>
                <label :for="name" class="btn btn-info">Selecionar Arquivos</label>
              </div>
            </td>
          </tr>
    ...
    <div class="example-foorer d-flex justify-content-end ">
      <div class="btn-group">
        <file-upload
...
export default {
  ...
  data() {
    return {
      files: [],
      accept: '',
      // accept: 'image/png,image/gif,image/jpeg,image/webp/pdf/SLDASM/SLDPRT',
      extensions: '',
      // extensions: 'gif,jpg,jpeg,png,webp,pdf,SLDASM,SLDPRT',
  ...
  mounted(){
    // console.log(" !$refs.upload", this.$refs.upload )
    // console.log(" refs.upload.active", this.$refs.upload.active )
  ...
  methods: {
    ...
    saveUpload(){
      this.$emit('filesDrawingRevision',  this.files)
    },
  ...
  async  inputFile(newFile, oldFile) {
   console.log(" input file new -->", newFile)
   console.log(" input file new2 -->", oldFile)
      if (newFile && oldFile) {
        // update
