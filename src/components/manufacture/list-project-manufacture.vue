                                  ...
                                  <div class="card-body pt-2 pb-3">
                                    ...
                                    <table class="table table-hover" style="margin-bottom: 0; width: 100%" v-for="value in item.drawings" :key="value.id_drawing" >
                                        <tbody  class="table-hover">                                                
                                          <tr v-if="value.status_drawing != 10" class="text-left border-left-0">
                                  ...
                                  <div class="accordion" id="accordionFlushExample">
                                    ...
                                    <table  class="table table-hover">
                                      <thead  class="accordion-item">
                                                    ...
                                                    <div class="input-group-prepend">
                                                      <span class="input-group-text">
                                                        <i class="mdi mdi-email-outline"></i>
                                                          ...
                                                          <input disabled type="time" step="1" class="form-control text-style" v-model="tempoTotalEdit"> 
                                                  </div>
                                                </div>
                                              </div>
                                              <div class="d-flex collum-form">
                                                ...
                                                <div class="form-group p-0 pr-1 col-lg-6 ">
                                                  ...
                                                  <div class="input-group">
                                                    <div class="input-group-prepend">
                                                      ...
                                                      <input type="time" step="1" class="form-control text-style"  @blur="onblur()" v-model="time_start">                                        
                                                    </div>
                                                </div>
                                                <div class="form-group p-0 pr-1 col-lg-6">
                                        ...
                                        <div v-if="btnAvaliarDrawing && (drawingDetails.status_drawing == 5)" class="mt-4 d-flex justify-content-center">
                                          <div class="d-flex">
...
export default {
  ...
  methods: {
    ...
    agendarTarefa(){
        ...
        let json =  { 
                      id_task: this.tarefaSelecionada.id_task,
                      id_user: this.colaboratorSelected,
                      date_scheduled_task: this.dataStartTask + ' ' + this.time_start,
      ...
      this.axios.post('/task/updatemfg', json)
      .then( response => {
          let res =  response.data;
          if(res.status == true ){
            this.Msg(
  ...
  async showModalInfoDrawing(value, val){
    ...
    listProjectMFG(){
      ...
      let json =  { status_drawing : [5, 7, 8, 10], }

      this.axios.post('/drawing/bystatus', json)
      .then((response) => {
        console.log(" project manufacture -> ", response)
        let res =  response.data;
        if(res.status == true ){
